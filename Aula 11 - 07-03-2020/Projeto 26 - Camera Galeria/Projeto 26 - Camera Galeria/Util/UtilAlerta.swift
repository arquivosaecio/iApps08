...
class UtilAlerta: NSObject {
    ...
    */
    ...
    /*
     ...
     let alertController = UIAlertController(title: "Informar", message: "Glicemia",
     preferredStyle: UIAlertController.Style.alert)
     
     let okAction = UIAlertAction(title: "OK", style: UIAlertAction.Style.default, handler: { alert -> Void in
     let firstTextField = alertController.textFields![0] as UITextField
     self.app.medicoes[MedicaoGlicemicaTableViewCell.idCelulaClicada].valorGlicemiaDigitado = Int(firstTextField.text!)!
